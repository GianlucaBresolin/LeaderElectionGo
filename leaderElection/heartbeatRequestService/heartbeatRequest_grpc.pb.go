...
const (
	HeartbeatService_HeartbeatRequestGRPC_FullMethodName = "/heartbeatRequestService.HeartbeatService/HeartbeatRequestGRPC"
)
...
type HeartbeatServiceClient interface {
	HeartbeatRequestGRPC(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*HeartbeatResponse, error)
}
...
func (c *heartbeatServiceClient) HeartbeatRequestGRPC(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*HeartbeatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HeartbeatResponse)
	err := c.cc.Invoke(ctx, HeartbeatService_HeartbeatRequestGRPC_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HeartbeatServiceServer interface {
	HeartbeatRequestGRPC(context.Context, *HeartbeatRequest) (*HeartbeatResponse, error)
...
func (UnimplementedHeartbeatServiceServer) HeartbeatRequestGRPC(context.Context, *HeartbeatRequest) (*HeartbeatResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HeartbeatRequestGRPC not implemented")
}
...
func _HeartbeatService_HeartbeatRequestGRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeartbeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HeartbeatServiceServer).HeartbeatRequestGRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HeartbeatService_HeartbeatRequestGRPC_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeartbeatServiceServer).HeartbeatRequestGRPC(ctx, req.(*HeartbeatRequest))
	}
...
var HeartbeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "heartbeatRequestService.HeartbeatService",
	HandlerType: (*HeartbeatServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "HeartbeatRequestGRPC",
			Handler:    _HeartbeatService_HeartbeatRequestGRPC_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "heartbeatRequest.proto",
}
